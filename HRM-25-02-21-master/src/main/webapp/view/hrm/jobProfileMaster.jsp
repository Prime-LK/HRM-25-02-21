					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Job Profile</h2>
							</div>
								...
								<form:form action="saveJobProfile" method="post"
										...
										<div class="col-sm-5">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:input class="form-control form-control-user"
													id="profile" path="profile" placeholder="Enter Job Profile" />
												<form:errors path="profile" cssClass="error1 text-danger" />
											</div>
										</div>

										<div class="col-sm-3 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="jbIDDiv">
												<!-- <label class="invisible"l>Job Profile ID</label> -->
												<form:input class="form-control form-control-user border-0"
													id="profileID" path="profileID" />
											</div>
										</div>
									...
									<div class="col-8 mb-3">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Job Profile"> <input type="reset"
