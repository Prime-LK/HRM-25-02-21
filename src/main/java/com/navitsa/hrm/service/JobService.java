...
public class JobService {
	...
	public List<JobProfileMaster> getAllJobProfileByCompany(String companyId) {
		return (List<JobProfileMaster>) jobrepo.getAllJobProfileByCompany(companyId);
	}

	public List<JobProfileDetails> getAllJobProfileDetailsByCompany(String companyId) {
		return (List<JobProfileDetails>) jobprofileDetailsRepo.getAllJobProfileDetailsByCompany(companyId);
	}

	public List<DesignationMaster> getAllDesignationMasterByCompany(String companyId) {
		return (List<DesignationMaster>) designationRepo.getAllDesignationsByCompany(companyId);
	}

	public List<SalaryGrade> getAllSalaryGradeByCompany(String companyId) {
		return (List<SalaryGrade>) salaryGradeRepo.getAllSalaryGradeByCompany(companyId);
	}
