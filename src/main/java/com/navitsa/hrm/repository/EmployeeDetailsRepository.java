...
public interface EmployeeDetailsRepository extends CrudRepository<EmployeeDetails, EmployeeDetailsPK> {
	...
	public List<EmployeeDetails> filterEmpdoj(@Param("joinedDate") String joinedDate,
			@Param("joinedDate2") String joinedDate2);
	...
	public String[][] filterEmpdojforReport(@Param("joinedDate") String joinedDate,
			@Param("joinedDate2") String joinedDate2);
	...
	public List<EmployeeDetails> filterEmpdateofresign(@Param("resignDate") String resignDate,
			@Param("resignDate2") String resignDate2);
	...
	public String[][] filterEmpdateOfResignDate(@Param("resignDate") String resignDate,
			@Param("resignDate2") String resignDate2);
	...
	@Query(value = "SELECT er FROM EmployeeDetails er WHERE er.department.depID=:departmentId AND er.company.comID=:companyId AND er.status = 'ACTIVE'")
	public List<EmployeeDetails> filterEmployeesByDepartmentAndCompany(@Param("departmentId") String departmentId,
	...
	public String[][] getEmployeeListrptPrivew(@Param("dep") String dep, @Param("dis") String dis,
			@Param("emptyp") String emptyp, @Param("empid") String empid, @Param("comID") String companyId);
	...
	public String[][] getEmployeeListrptPrivewbyreligion(@Param("dep") String dep, @Param("dis") String dis,
			@Param("emptyp") String emptyp, @Param("empid") String empid, @Param("empcat") String empcat,
			@Param("religion") String religion, @Param("civista") String civista, @Param("comID") String companyId);
	...
	@Query(value = "SELECT ed FROM EmployeeDetails ed WHERE ed.detailsPK.empID.empID = :employeeId AND ed.company.comID = :companyId")
	...
	public List<EmployeeDetails> getEmployeeDetailsByEmpid(@Param("companyID") String companyID,
