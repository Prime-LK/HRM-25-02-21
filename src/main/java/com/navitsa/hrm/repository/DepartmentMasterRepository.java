...
public interface DepartmentMasterRepository extends CrudRepository<DepartmentMaster, String> {
	...
	public DepartmentMaster getDepartmentByIdAndCompany(@Param("departmentId") String departmentId,
	...
	@Query(value = "SELECT dm FROM DepartmentMaster dm WHERE dm.company.comID = :companyId")
	public List<DepartmentMaster> getAllDepartmentByCompany(@Param("companyId") String companyId);
}
