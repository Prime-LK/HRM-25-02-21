...
public interface ShiftMasterRepository extends CrudRepository<ShiftMaster, String> {
	...
	public ShiftMaster findShiftByIdAndCompany(@Param("shiftId") String shiftId, @Param("companyId") String companyId);
	...
	@Query(value = "SELECT sm FROM ShiftMaster sm WHERE sm.company.comID=:companyId")
	public List<ShiftMaster> findAllShiftsByCompany(@Param("companyId") String companyId);
