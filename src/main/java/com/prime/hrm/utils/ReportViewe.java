...
public class ReportViewe {
	...
	public void pdfReportViewfileDownload(String jasperName,String reportName,Collection<?> rates,Map<String,Object> params, HttpServletResponse response) throws Exception {
	...
	public String pdfReportViewInlineSystemOpen(String jasperName,String reportName,Collection<?> rates,Map<String,Object> params,HttpServletResponse response) throws Exception {
...
//        response.setContentType("application/pdf");
 //   response.setHeader("Content-Length", String.valueOf(pdfReportStream.size()));
   //   response.addHeader("Content-Disposition", "inline; filename=jasper.pdf;");
	...
	public void htmlReportView(String jasperName,String reportName,Collection<?> rates,Map<String,Object> params, HttpServletResponse response) throws Exception {
