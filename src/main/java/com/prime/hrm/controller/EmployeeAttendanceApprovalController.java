...
public class EmployeeAttendanceApprovalController {
	...
	public String employeeAttendanceApprovalPage() {
		return "employeeAttendanceApproval";
	}
	...
	public String loadAttendance(@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate,
		...
		if ((departmentId.equals("All") || departmentId == null) && (employeeId.equals("All") || employeeId == null) && (shiftId.equals("All") || shiftId == null) && (approvalStatus == null)) {
			// Dates
			List<String> attendances = employeeAttendanceService.loadAttendancesByApprovalStatus(startDate, endDate, 0);
			/*List<String> attendances = employeeAttendanceService.loadAttendancesByDate(startDate, endDate);*/
			model.put("filteredAttendanceList", attendances);
		} else if ((employeeId.equals("All") || employeeId == null) && (shiftId.equals("All") || shiftId == null) && (approvalStatus == null)) {
			// Department
			List<String> attendances = employeeAttendanceService.loadAttendancesByDepartmentAndApprovalStatus(startDate, endDate, departmentId, 0);
			/*List<String> attendances = employeeAttendanceService.loadAttendancesByDepartment(startDate, endDate,
					departmentId);*/
			model.put("filteredAttendanceList", attendances);
		} else if ((departmentId.equals("All") || departmentId == null) && (employeeId.equals("All") || employeeId == null) && (approvalStatus == null)) {
			// Shift
			...
			model.put("filteredAttendanceList", attendances);
		} else if ((departmentId.equals("All") || departmentId == null) && (employeeId.equals("All") || employeeId == null) && (shiftId.equals("All") || shiftId == null)) {
			// Approval Status
			List<String> attendances = employeeAttendanceService.loadAttendancesByApprovalStatus(startDate, endDate,
					Integer.valueOf(approvalStatus));
			model.put("filteredAttendanceList", attendances);
			...
			List<String> attendances = employeeAttendanceService.loadAttendancesByDepartmentAndShiftAndApprovalStatus(
					startDate, endDate, departmentId, shiftId, Integer.valueOf(approvalStatus));
			model.put("filteredAttendanceList", attendances);
			...
			if (!employeeId.equals("All") && !(employeeId == null)) {
				...
				List<String> attendances = employeeAttendanceService.loadAttendancesByEmployeeAndApprovalStatus(startDate,
						endDate, departmentId, employeeId, 0);
