...
public interface EmployeeAttendanceRepository extends CrudRepository<EmployeeAttendance, String> {
	...
	@Query(value = "SELECT employee_attendance.attendance_id, employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_id, shift_allocation.department_name,employee_attendance.shift_id, shift_allocation.shift_name,\r\n"
			...
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id WHERE employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			...
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId AND employee_attendance.approved = :approvalStatus AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.approved = :approvalStatus AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.approved = :approvalStatus AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.approved = :approvalStatus AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n"
			+ "FROM employee_attendance\r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.shift_id = :shiftId AND employee_attendance.approved = :approvalStatus AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT year, month, employee_id, employee_name,\r\n"
			...
			+ "WHERE shift_allocation.employee_id = :employeeId AND month(shift_allocation.date) = :month AND  year(shift_allocation.date) = :year AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId)main", nativeQuery = true)
	public String[][] loadMainReportDetails3(@Param("year") int year, @Param("month") int month,
			@Param("employeeId") String employeeId, @Param("companyId") String companyId);
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%Y-%m-%d\") as date, DATE_FORMAT(shift_allocation.date, \"%W\") as weekday, calander.Description as day_type, employee_attendance.on_time, employee_attendance.off_time, \r\n"
			...
			+ "LEFT JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id)\r\n"
			+ "WHERE shift_allocation.employee_id = :employeeId AND month(shift_allocation.date) = :month AND  year(shift_allocation.date) = :year  AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId", nativeQuery = true)
	public String[][] loadSubReportDetails3(@Param("year") int year, @Param("month") int month,
			@Param("employeeId") String employeeId, @Param("companyId") String companyId);
	...
	@Query(value = "UPDATE employee_attendance\r\n"
			...
			+ "WHERE employee_id = :employeeId AND shift_id = :shiftId AND date = :date AND employee_attendance.company_id = :companyId", nativeQuery = true)
	public EmployeeAttendance reviseEmployeeAttendance(@Param("onTime") String onTime, @Param("offTime") String offTime,
			@Param("approved") String approved, @Param("cancelled") String cancelled, @Param("shiftId") String shiftId,
			@Param("employeeId") String employeeId, @Param("date") String date, @Param("companyId") String companyId);
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "WHERE employee_attendance.date = :date AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "FROM employee_attendance \r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "FROM employee_attendance \r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date = :date AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "FROM employee_attendance \r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "FROM employee_attendance \r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n"
			...
			+ "FROM employee_attendance \r\n"
			+ "INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n"
			+ "WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.shift_id = :shiftId AND employee_attendance.company_id = :companyId AND shift_allocation.company_id = :companyId", nativeQuery = true)
