...
public interface EmployeeAttendanceRepository extends CrudRepository<EmployeeAttendance, String> {
	...
	@Query(value = "SELECT employee_attendance.attendance_id, employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_id, shift_allocation.department_name,employee_attendance.shift_id, shift_allocation.shift_name,\r\n" + 
			...
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
	...
	public List<String> loadAttendancesByDepartment(@Param("startDate") String startDate, @Param("endDate") String endDate,
			@Param("departmentId") String departmentId);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByDepartmentAndShiftAndApprovalStatus(@Param("startDate") String startDate,
			@Param("endDate") String endDate, @Param("departmentId") String departmentId, @Param("shiftId") String shiftId,
			@Param("approvalStatus") int approvalStatus);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	public List<String> loadAttendancesByDepartmentAndShift(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("departmentId") String departmentId,  @Param("shiftId") String shiftId);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByDepartmentAndApprovalStatus(@Param("startDate") String startDate,
			@Param("endDate") String endDate, @Param("departmentId") String departmentId, @Param("approvalStatus") int approvalStatus);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId", nativeQuery = true)
	public List<String> loadAttendancesByEmployee(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("departmentId") String departmentId,  @Param("employeeId") String employeeId);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	public List<String> loadAttendancesByEmployeeAndShift(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("departmentId") String departmentId,  @Param("employeeId") String employeeId, @Param("shiftId") String shiftId);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByEmployeeAndApprovalStatus(@Param("startDate") String startDate,
			@Param("endDate") String endDate, @Param("departmentId") String departmentId, @Param("employeeId") String employeeId, 
			@Param("approvalStatus") int approvalStatus);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByApprovalStatus(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("approvalStatus") int approvalStatus);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND employee_attendance.shift_id = :shiftId AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByShiftAndApprovalStatus(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("shiftId") String shiftId, @Param("approvalStatus") int approvalStatus);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\"), employee_attendance.employee_id, shift_allocation.employee_name, shift_allocation.department_name, employee_attendance.shift_id, shift_allocation.shift_name, employee_attendance.on_time, employee_attendance.off_time, employee_attendance.approved, employee_attendance.company_id \r\n" + 
			"FROM employee_attendance\r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.date = shift_allocation.date AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.shift_id = :shiftId AND employee_attendance.approved = :approvalStatus", nativeQuery = true)
	public List<String> loadAttendancesByEmployeeAndShiftAndApprovalStatus(@Param("startDate") String startDate, @Param("endDate") String endDate, 
			@Param("departmentId") String departmentId,  @Param("employeeId") String employeeId, 
			@Param("shiftId") String shiftId, @Param("approvalStatus") int approvalStatus);
	...
	@Query(value = "SELECT year, month, employee_id, employee_name,\r\n" + 
			...
			"WHERE shift_allocation.employee_id = :employeeId AND month(shift_allocation.date) = :month AND  year(shift_allocation.date) = :year)main", nativeQuery = true)
	public String[][] loadMainReportDetails3(@Param("year") int year, @Param("month") int month, @Param("employeeId") String employeeId);
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%Y-%m-%d\") as date, DATE_FORMAT(shift_allocation.date, \"%W\") as weekday, calander.Description as day_type, employee_attendance.on_time, employee_attendance.off_time, \r\n" + 
			...
			"LEFT JOIN applyleaves ON shift_allocation.date = applyleaves.Date AND shift_allocation.employee_id = applyleaves.Employee_ID\r\n" + 
			"LEFT JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id)\r\n" + 
			"WHERE shift_allocation.employee_id = :employeeId AND month(shift_allocation.date) = :month AND  year(shift_allocation.date) = :year", nativeQuery = true)
	public List<String> loadSubReportDetails(@Param("year") int year, @Param("month") int month, @Param("employeeId") String employeeId);
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%Y-%m-%d\") as date, DATE_FORMAT(shift_allocation.date, \"%W\") as weekday, calander.Description as day_type, employee_attendance.on_time, employee_attendance.off_time, \r\n" + 
			...
			"LEFT JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id)\r\n" + 
			"WHERE shift_allocation.employee_id = :employeeId AND month(shift_allocation.date) = :month AND  year(shift_allocation.date) = :year", nativeQuery = true)
	public String[][] loadSubReportDetails3(@Param("year") int year, @Param("month") int month, @Param("employeeId") String employeeId);
	
	@Query(value = "SELECT * FROM employee_attendance WHERE employee_attendance.date=:date AND employee_attendance.shift_id=:shiftId AND employee_attendance.employee_id=:employeeId", nativeQuery = true)
	public EmployeeAttendance findEmployeeAttendanceByDetails(@Param("date") String date, @Param("shiftId") String shiftId,
			@Param("employeeId") String employeeId);
	
	@Query(value = "UPDATE employee_attendance\r\n" + 
			"SET on_time = :onTime, off_time = :offTime, approved = :approved, cancelled = :cancelled\r\n" + 
			"WHERE employee_id = :employeeId AND shift_id = :shiftId AND date = :date", nativeQuery = true)
	public EmployeeAttendance reviseEmployeeAttendance(@Param("onTime") String onTime, @Param("offTime") String offTime, @Param("approved") String approved, @Param("cancelled") String cancelled, 
			@Param("shiftId") String shiftId, @Param("employeeId") String employeeId, @Param("date") String date);
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			...
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date", nativeQuery = true)
	public String[][] loadAttendanceRecordsByDate(@Param("date") String date);

	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			"TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time, employee_attendance.off_time, CASE WHEN employee_attendance.approved = 1 THEN 'Yes' WHEN employee_attendance.approved = 0 THEN 'No' ELSE null END AS approval_status\r\n" + 
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId", nativeQuery = true)
	public String[][] loadAttendanceRecordsByDepartment(@Param("date") String date, @Param("departmentId") String departmentId);
	
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			"TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time, employee_attendance.off_time, CASE WHEN employee_attendance.approved = 1 THEN 'Yes' WHEN employee_attendance.approved = 0 THEN 'No' ELSE null END AS approval_status\r\n" + 
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	...
	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			...
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	public String[][] loadAttendanceRecordsByDepartmentAndShift(@Param("date") String date, @Param("departmentId") String departmentId, @Param("shiftId") String shiftId);

	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			"TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time, employee_attendance.off_time, CASE WHEN employee_attendance.approved = 1 THEN 'Yes' WHEN employee_attendance.approved = 0 THEN 'No' ELSE null END AS approval_status\r\n" + 
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId", nativeQuery = true)
	public String[][] loadAttendanceRecordsByEmployee(@Param("date") String date, @Param("departmentId") String departmentId, @Param("employeeId") String employeeId);

	@Query(value = "SELECT employee_attendance.attendance_id, DATE_FORMAT(employee_attendance.date, \"%d-%m-%Y\") AS date, employee_attendance.shift_id, shift_allocation.shift_name, shift_allocation.department_id, shift_allocation.department_name, employee_attendance.employee_id, shift_allocation.employee_name, \r\n" + 
			"TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time, employee_attendance.off_time, CASE WHEN employee_attendance.approved = 1 THEN 'Yes' WHEN employee_attendance.approved = 0 THEN 'No' ELSE null END AS approval_status\r\n" + 
			"FROM employee_attendance \r\n" + 
			"INNER JOIN shift_allocation ON employee_attendance.date = shift_allocation.date AND employee_attendance.employee_id = shift_allocation.employee_id AND employee_attendance.shift_id = shift_allocation.shift_id\r\n" + 
			"WHERE employee_attendance.date = :date AND shift_allocation.department_id = :departmentId AND employee_attendance.employee_id = :employeeId AND employee_attendance.shift_id = :shiftId", nativeQuery = true)
	public String[][] loadAttendanceRecordsByEmployeeAndShift(@Param("date") String date, @Param("departmentId") String departmentId, @Param("employeeId") String employeeId, @Param("shiftId") String shiftId);
}
