...
public interface ShiftAllocationRepository extends CrudRepository<ShiftAllocation, ShiftAllocationPK> {
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") as date, calander.Types,\n"
			...
			+ "WHERE shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId;", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			...
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			+ "FROM ((shift_allocation\r\n" + "INNER JOIN calander ON shift_allocation.date = calander.Date)\r\n"
			+ "INNER JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id) \r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			+ "FROM ((shift_allocation\r\n" + "INNER JOIN calander ON shift_allocation.date = calander.Date)\r\n"
			+ "INNER JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id) \r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.shift_id = :shiftId  AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			+ "FROM ((shift_allocation\r\n" + "INNER JOIN calander ON shift_allocation.date = calander.Date)\r\n"
			+ "INNER JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id) \r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND shift_allocation.employee_id = :employeeId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			+ "FROM ((shift_allocation\r\n" + "INNER JOIN calander ON shift_allocation.date = calander.Date)\r\n"
			+ "INNER JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id) \r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND shift_allocation.shift_id = :shiftId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") AS date, DATE_FORMAT(shift_allocation.date, \"%W\") AS weekday, calander.Description AS day_type, shift_allocation.shift_name as shift, shift_allocation.department_name AS department, shift_allocation.employee_name AS employee_name, TIME_FORMAT(shift_allocation.start_time, \"%H:%i\") AS start_time, TIME_FORMAT(shift_allocation.end_time, \"%H:%i\") AS end_time, employee_attendance.on_time AS on_time, employee_attendance.off_time AS off_time\r\n"
			+ "FROM ((shift_allocation\r\n" + "INNER JOIN calander ON shift_allocation.date = calander.Date)\r\n"
			+ "INNER JOIN employee_attendance ON shift_allocation.date = employee_attendance.date AND shift_allocation.employee_id = employee_attendance.employee_id AND shift_allocation.shift_id = employee_attendance.shift_id) \r\n"
			+ "WHERE employee_attendance.date BETWEEN :startDate AND :endDate AND shift_allocation.department_id = :departmentId AND shift_allocation.employee_id = :employeeId AND shift_allocation.shift_id = :shiftId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId AND employee_attendance.company_id = :companyId", nativeQuery = true)
	...
	@Query(value = "SELECT DATE_FORMAT(shift_allocation.date, \"%d-%m-%Y\") as date, calander.Types, \n"
			...
			+ "INNER JOIN calander ON shift_allocation.date = calander.Date\n"
			+ "WHERE shift_allocation.date BETWEEN :startDate AND :endDate AND shift_allocation.shift_id = :shiftId AND shift_allocation.company_id = :companyId AND calander.CompanyID = :companyId", nativeQuery = true)
