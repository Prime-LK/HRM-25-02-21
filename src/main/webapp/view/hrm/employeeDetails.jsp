								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col">
													<div class="" id="card001" style="width: 10rem;">
														<ul class="list-group list-group-flush">
															<li class="list-group-item">EPF No</li>
															<li class="list-group-item">Joined Date</li>
															<li class="list-group-item">Status</li>
															<li class="list-group-item">Basic Salary</li>
															<li class="list-group-item">Designation</li>
														</ul>
													</div>
												</div>
												<div class="col">
													<div class="" id="card001Details" style="width: 10rem;">
													</div>
												</div>
												<div class="col">
													<div class="" id="card002" style="width: 10rem;">
														<ul class="list-group list-group-flush">
															<li class="list-group-item">Category</li>
															<li class="list-group-item">Type</li>
															<li class="list-group-item">Department</li>
															<li class="list-group-item">Salary Grade</li>
															<li class="list-group-item">Salary Range</li>
														</ul>
													</div>
												</div>
												<div class="col">
													<div class="" id="card002Details" style="width: 10rem;">
													</div>
												</div>
												<div class="col">
													<div class="" id="card003" style="width: 10rem;">
														<ul class="list-group list-group-flush">
															<li class="list-group-item">Direct Reporter</li>
															<li class="list-group-item">Job profile</li>
															<li class="list-group-item">Location</li>
															<li class="list-group-item">Resign Date</li>
															<li class="list-group-item" id="editLi"><a
												...
												<div class="col">
													<div class="" id="card003Details" style="width: 10rem;">
													</div>
												</div>
											</div>
										</div>
