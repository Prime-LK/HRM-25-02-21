					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Employee Category Details</h2>
							</div>
									...
									<div class="form-group row">
										<div class="col-sm-4">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:errors path="category" cssClass="error1 text-danger" />
											</div>
										</div>
										<div class="col-sm-4 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="catIDDiv">
												<!-- <label>Category ID</label> -->
												<form:input class="form-control form-control-user"
													id="catgoryID" path="catgoryID"
													placeholder="Enter Category ID" readOnly="true" />
											</div>
										</div>
