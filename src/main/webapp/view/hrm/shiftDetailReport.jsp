...
<body onload="checkStatusofDropdowns();">
					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-4 col-lg-4">
								<h2 class="text-white pb-2 fw-bold">Shift Detail Report</h2>
							</div>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<form:form action="generateShiftDetailReport"
													...
													<div class="form-group row">
														...
														<div class="col-sm-3">
															<label>Employee Name</label> <select
																...
																class="form-control form-control-user col-12 foo text-capitalize"
																onchange="">
																<option value="All" selected>- Select Employee
																	-</option>
															</select>
														</div>
														<div class="col-sm-3">
															<label>Shift Name</label> <select id="shiftId"
																name="shiftId"
																class="form-control form-control-user col-12 foo text-capitalize">
																<option value="All" selected>- Select Shift -</option>
													...
													<div class="form-group row">
														<div class="col-sm-9">
															<input type="button"
																...
																value="Load Shift Details" onclick="loadShiftDetails()" />
															<input type="submit"
																class="btn btn-success btn-sm-3 mr-3"
																value="Generate Shift Detail Report" /> <input
										...
										<div class="card shadow mb-4">
											<div class="card-header py-3">
												<h6 class="m-0 font-weight-bold text-primary">Shift
													Details</h6>
											</div>
											<div class="card-body">
	...
	<script src="<c:url value='/resources/hrm/ajax/shiftDetailsReport.js'/>"></script>
