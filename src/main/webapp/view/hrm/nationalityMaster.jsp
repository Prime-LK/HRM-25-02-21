					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Nationality Details</h2>
							</div>
								...
								<form:form action="saveNaMaster" method="post"
									...
									<div class="form-group row">
										...
										<div class="col-sm-3 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="naDiv">
												<!-- <label>Nationality ID</label> -->
												<form:input class="form-control form-control-user" id="nId"
													path="nId" placeholder="Enter Nationality ID"
													readOnly="true" />
											</div>
										</div>
									...
									<div class="col-3 mb-4">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Nationality Details"> <input type="reset"
