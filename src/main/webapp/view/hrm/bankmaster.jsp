					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Bank Details</h2>
							</div>
						...
						<div class="card">
							<div class="card-body">
								<form:form action="saveBank" method="post"
									...
									<div class="row col-sm-4 mt-4 ml-0">
										<div class="col-sm-60 mb-1 mb-sm-3">
											<label>Bank Code</label>
											<form:input class="form-control form-control-user"
												id="bankid" path="bankid" placeholder="Enter Bank code" />
											<form:errors path="bankid" cssClass="error1 text-danger" />
									...
									<div class="form-group row">
										<div class="col-sm-4">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:input class="form-control form-control-user"
													id="bankName" path="bankName" placeholder="Enter Bank Name" />
												<form:errors path="bankName" cssClass="error1 text-danger" />
									...
									<div class="col-7 mb-4">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Bank Details"> <input type="reset"
