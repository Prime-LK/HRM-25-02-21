					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Document Details</h2>
							</div>
								...
								<form:form action="saveEmployeeDocument" method="post"
										...
										<div class="col-sm-5">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:input class="form-control form-control-user"
													path="docType" placeholder="Enter Document Type" />
												<form:errors path="docType" cssClass="error1 text-danger" />
											</div>
										</div>

										<div class="col-sm-4 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="docTypeIDDiv">
												<!-- <label>Document Type ID</label> -->
												<form:input class="form-control form-control-user"
													id="docTypeId" path="docTypeId"
													placeholder="Enter Document Type ID" readOnly="true" />
											</div>
										</div>
									...
									<div class="col-7 mb-4">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Document Details"> <input type="reset"
