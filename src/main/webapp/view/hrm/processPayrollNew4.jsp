...
<link href="<c:url value='/resources/hrm/css/processPayrollNew4.css'/>"
	rel="stylesheet">
...
<body onload="getCompletePage();checkStatusofDropdowns();">
			...
			<div class="content">
				...
				<div class="page-inner mt--5">
					<div class="container-fluid">
						<div class="card">
							<div class="card-body">
								<form:form action="saveProcessPayRollData4" method="post"
									onSubmit="formValidation()" id="ProcessPayrollPage4"
									modelAttribute="processPayrollPage4">
									<div class="row">
										<div class="col-6">
											...
											<div class="form-group row">
												...
												<div class="col-7">
													<input name="startDate" type="text" class="form-control"
														id="startDate" placeholder="Start Date" readOnly />
												</div>
											</div>
										</div>
									...
									<div class="row">
											...
											<div class="form-group row">
												...
												<div class="col-7">
													<input name="endDate" type="text" class="form-control"
														id="endDate" placeholder="End Date" readOnly />
												</div>
											</div>
										</div>
										<div class="col" id="processUserDiv">
											<div class="form-group row">
												<div class="col-7">
													<div class="form-group col-6 row ml-3">
														<label id="lcode">Process User</label>
														<div class="col">
											...
											<div class="form-group row">
												...
												<div class="col-7">
													<input type="text" id="payCodeID" name="payCodeID"
														class="form-control" placeholder="PayCode" readOnly/>
												</div>
											</div>
										</div>
										<div class="col-6">
											<div class="form-group row">
												...
												<div class="col-7">
													<input name="periodID" type="text" onchange=""
														class="form-control" id="periodID" placeholder="PayPeriod" readOnly /> <span
														id="div2"></span>
												</div>
											</div>
										</div>
	...
	<script src="<c:url value='resources/hrm/ajax/processPayrollNew4.js'/>"></script>
