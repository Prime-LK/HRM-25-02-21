...
<body onload="checkStatusofDropdowns();">
					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-12 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Employee Allowance Report</h2>
							</div>
	...
	<div class="col-xl-3 col-lg-5" >			
					<!-- Card -->
			<form:form action="employeeAllocateMonthlyAllowances"  method="GET">		
												...
												<div class="row">
													<div class="col-10">
														<div class="form-group">
															...
															<select name="paytype"
																...
																<c:forEach items="${addDedTypeRpts}" var="b">
																	<option value="${b.deductTypeCode}">${b.desc}</option>
																</c:forEach>
															</select>
														</div>
													</div>
													...
													<div class="col-10">
														<label class="form-group">Pay Period</label> <select
															class="custom-select" id="paycode"
															name="paycode"  required>
															<option value="">select Pay Period</option>
															<c:forEach items="${payPerioadrpt}" var="pship">
