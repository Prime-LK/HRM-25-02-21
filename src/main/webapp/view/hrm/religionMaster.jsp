					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Religion Details</h2>
							</div>
								...
								<form:form action="saveReligion" method="post"
										...
										<div class="col-sm-4">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:input class="form-control form-control-user"
													id="religion" path="religion" placeholder="Enter Religion" />
												<form:errors path="religion" cssClass="error1 text-danger" />
											</div>
										</div>
										<div class="col-sm-3 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="reID">
												<!-- <label>Religion ID</label> -->
												<form:input class="form-control form-control-user" id="rid"
													path="rid" placeholder="Enter Religion ID" readOnly="true" />
											</div>
										</div>
										<div class="col-sm-3 mt-4">
									...
									<div class="col-7 mb-4">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Religion Details"> <input type="reset"
