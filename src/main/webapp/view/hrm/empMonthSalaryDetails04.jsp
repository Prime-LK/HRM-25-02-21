								...
								<div class="container">
									<form:form action="saveEmpMoSaDetails04" method="post"
										...
										<div class="row">
											...
											<div class="col-4">
												<div class="form-group row" id="startDateDiv">
													<label class="col-3 mt-1">Start Date</label>
													<div class="col-7">
														<form:input type="text" id="pYear" path="pYear"
										...
										<div class="row">
											...
											<div class="col-4">
												<div class="form-group row" id="endDateDiv">
													<label class="col-3 mt-1">End Date</label>
													<div class="col-7">
														<form:input type="text" class="form-control" id="pMonth"
															path="pMonth" onchange="getPeriodIDReDates4()"
												...
												<div class="form-group row" id="payCodeValDiv">
													...
													<div class="col-7">
														<input type="text" name="periodCode" class="form-control"
															id="PayCodeVal" placeholder="PayCode" readOnly>
													</div>
												</div>
											</div>
											<div class="col-4" id="payPeriodDiv">
												<div class="form-group row">
													<label class="col-5 mt-1">PayPeriod</label>
													<div class="col-7">
														<input type="text" name="periodCode" class="form-control"
															id="periodCode" placeholder="PayPeriod" readOnly>
													</div>
												</div>
											</div>
											<div class="col-3" id="payCodeDiv">
												<div class="form-group row">
										...
										<div class="row">
											...
											<div class="col-4" id="alloTypeDiv">
												<div class="form-group row">
											...
											<tbody>
												<c:forEach items="${findAllEmpMoSaDetails}" var="s">
													<tr>
														...
														<td id="tItem"><div>
																<a href="updateDeductForm?id=${s.monthDePk.empID.empID}"><i
