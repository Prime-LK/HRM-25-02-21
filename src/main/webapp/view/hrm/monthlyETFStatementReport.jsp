...
<body onload="getEmployee();">
					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-12 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Monthly E.T.F Statement</h2>
							</div>
	...
	<div class="col-xl-3 col-lg-5" >			
					<!-- Card -->
			<form:form action="getmonthlyetfreport"  method="POST">		
							...
							<div class="card-body">
								...
								<div class="col-sm-12">
												<label class="l-fontst">Pay Period</label> <select
													...
													<c:forEach items="${payPeriodETF}" var="payPeriodPayShip" >
