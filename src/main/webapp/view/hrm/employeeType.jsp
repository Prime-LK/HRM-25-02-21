					...
					<div class="page-inner py-3">
						<div
							...
							<div class="col-xl-2 col-lg-2">
								<h2 class="text-white pb-2 fw-bold">Employee Type Details</h2>
							</div>
								...
								<form:form action="saveEmployeeType" method="post"
									...
									<div class="form-group row">
										<div class="col-sm-4">
											<div class="col-sm-60 mb-1 mb-sm-3">
												...
												<form:input class="form-control form-control-user" id="type"
													path="type" placeholder="Enter Employee Type" />
												<form:errors path="type" cssClass="error1 text-danger" />
											</div>
										</div>
										<div class="col-sm-4 mt-4">
											<div class="col-sm-30 mb-1 mb-sm-3" id="empTypeIDDiv">
												<!-- <label>Employee ID</label> -->
												<form:input class="form-control form-control-user" id="tid"
													path="tid" placeholder="Enter Employee ID" readOnly="true" />
											</div>
										</div>
									...
									<div class="col-7 mb-4">
										<input type="submit" class="btn btn-success btn-sm"
											value="Add Employee Type"> <input type="reset"
