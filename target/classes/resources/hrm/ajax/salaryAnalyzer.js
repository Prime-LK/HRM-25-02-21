function loadAllAllowances() {
	...
	if (a == true) {
		$.ajax({
			type : 'GET',
			url : "getAllAllowances",
			success : function(data) {
				$("#alloTable tbody").empty();
				for (var i = 0; i < data.length; i++) {
					var result = "<tr>" + "<td id='alloData'>"
							+ data[i].deductTypeCode + "</td>"
							+ "<td id='alloData'>" + data[i].desc
							+ "</td></tr>";
...
function saveListOfData() {
	...
	$.ajax({
		type : 'POST',
		url : "saveListSaDetails",
		data: { "saPK.year":a, "saPK.month":b, "saPK.depatment.depID":c, "company.comID":d },
		success : function(data) {
...
//		data: { "saPK.year":a, "saPK.month":b, "saPK.depatment.depID":c, "company.comID":d, "saPK.addDedType.deductTypeCode":e },
//		success : function(data) {
//			console.log('data saved successfully');
//		},
//		error : function() {
